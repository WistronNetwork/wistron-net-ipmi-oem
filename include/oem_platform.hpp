...
enum wistron_oem_cmds
{
    ...
    WIS_CMD_SET_TEMPERATURE_SENSOR_READING = 0x86,
    WIS_CMD_GET_TEMPERATURE_SENSOR_READING = 0x87,
    WIS_CMD_GET_PSU_EEPROM_INFORMATION = 0x88,
    WIS_CMD_GET_PSU_INFORMATION = 0x89,
    WIS_CMD_GET_PSU_MFR_INFORMATION = 0x8a,
    WIS_CMD_SET_SYSTEM_LED = 0x8b,
    WIS_CMD_GET_SYSTEM_LED = 0x8c,
    WIS_CMD_SET_CPLD_REGISTER_VALUE = 0x8d,
    WIS_CMD_GET_CPLD_REGISTER_VALUE = 0x8e,

...
enum wistron_oem_cmds
{
    ...
    WIS_CMD_GET_UART_MUX_MASTER = 0x83,
    WIS_CMD_SET_INTERNAL_SENSOR_READING = 0x84,
    WIS_CMD_GET_INTERNAL_SENSOR_READING = 0x85,
    WIS_CMD_GET_INTERNAL_SENSOR_THRESHOLD_READING = 0x87,
    WIS_CMD_GET_PSU_SENSOR_READING = 0x89,
    WIS_CMD_GET_PSU_SENSOR_THRESHOLD_READING = 0x8a,
    WIS_CMD_GET_PSU_INFORMATION = 0x8b,
    WIS_CMD_GET_FAN_INFORMATION = 0x8c,
...
class OemPlatform : public OemCommon
{
  public:
    ...
    {
        i2c_mux_sel = "GPIOQ6";
        i2c_mux_sel_path = "/sys/class/leds/GPIOQ6/brightness";
    }

    int getPSUFanDirection(uint8_t psu, IdInfoMap_Psu::iterator iter) override;
};

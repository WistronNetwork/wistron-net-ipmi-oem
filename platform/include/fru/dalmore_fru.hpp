...
const char* frulist[FRU_MAX] = {
    ...
    "/sys/bus/i2c/devices/40-0051/eeprom", // fru 1: FAN1
    "/sys/bus/i2c/devices/40-0053/eeprom", // fru 2: FAN2
    "/sys/bus/i2c/devices/40-0055/eeprom", // fru 3: FAN3
    "/sys/bus/i2c/devices/41-0051/eeprom", // fru 4: FAN4
    "/sys/bus/i2c/devices/41-0053/eeprom", // fru 5: FAN5
    "/sys/bus/i2c/devices/41-0055/eeprom", // fru 6: FAN6
    "/sys/bus/i2c/devices/42-0051/eeprom"  // fru 7: FAN7
};

IdInfoMap_External_Sensor oem_externalsensors = {
    {1,{.size = 1, .path = "/xyz/openbmc_project/sensors/temperature/CPU_TMP"}},
    {2,{.size = 1, .path = "/xyz/openbmc_project/sensors/temperature/DIMM_TMP"}},
    {3,{.size = 1, .path = "/xyz/openbmc_project/sensors/temperature/MAC_DIE_TMP"}},
    {4,{.size = 1, .path = "/xyz/openbmc_project/sensors/temperature/M2_SSD_TMP"}},
    ...
    {37,{.size = 1, .path = "/xyz/openbmc_project/sensors/temperature/QSFP_P32_TMP"}},
};

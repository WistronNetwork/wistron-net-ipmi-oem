...
IdInfoMap_Fan fan_info = {
    ...
    },
    {
        ...
        {
            .presentPath = FANCPLD_PATH,
            .presentAttr = "fm_det_fan5_n",
            .directionPath = FANCPLD_PATH,
            .directionAttr = "fm_judgement_fan5",
            .pwmPath = FANCPLD_PATH,
            .pwmAttr = "pwm5",
        }
    },
    {
        ...
        {
            .presentPath = FANCPLD_PATH,
            .presentAttr = "fm_det_fan6_n",
            .directionPath = FANCPLD_PATH,
            .directionAttr = "fm_judgement_fan6",
            .pwmPath = FANCPLD_PATH,
            .pwmAttr = "pwm6",
        }
    },
    {
        ...
        {
            .presentPath = FANCPLD_PATH,
            .presentAttr = "fm_det_fan7_n",
            .directionPath = FANCPLD_PATH,
            .directionAttr = "fm_judgement_fan7",
            .pwmPath = FANCPLD_PATH,
            .pwmAttr = "pwm7",
        }
    },

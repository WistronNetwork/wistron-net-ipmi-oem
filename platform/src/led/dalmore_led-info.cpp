...
Dalmore_IdInfoMap_LED dalmore_led_info = {
    {
        1, /* For System LED */
        {
            .ledColorPath = CPLD0_PATH,
            .ledColorAttr = "sys_led_color_control",
            .ledBlinkPath = CPLD0_PATH,
            .ledBlinkAttr = "sys_led_blink_control",
        }
    },
    {
        2, /* For PSU LED */
        {
            ...
            .ledBlinkPath = CPLD0_PATH,
            .ledBlinkAttr = "psu_led_blink_control",
        }
    },
    {
        3, /* For Fan LED */
        {
            ...
            .ledBlinkPath = CPLD0_PATH,
            .ledBlinkAttr = "fan_led_blink_control",
        }
    },
    {
        4, /* For LOC LED */
        {
            ...
            .ledBlinkPath = CPLD0_PATH,
            .ledBlinkAttr = "loc_led_blink_control",
        }
    },
};
